...
describe('codex hubot script', function() {
  ...
  describe('setAnswer', function() {
    it('fails when puzzle does not exist', function() {
      ...
      return waitForDocument(Messages, {nick: 'testbot', timestamp: 7}, {
    ...
    it('sets answer', async function() {
      ...
      return waitForDocument(Messages, {nick: 'testbot', body: /^@torgen:/}, {
        timestamp: 7,
        useful: true,
        room_name: 'puzzles/12345abcde',
        mention: ['torgen']
    ...
    return it('leaves old answer', async function() {
      Puzzles.insert({
        _id: '12345abcde',
        name: 'Latino Alphabet',
        canon: 'latino_alphabet',
      ...
      return chai.assert.deepInclude(Puzzles.findOne({_id: '12345abcde'}), {
        touched: 3,
        touched_by: 'cjb',
        solved: 3,
        solved_by: 'cscott',
  ...
  describe('deleteAnswer', function() {
    ...
    return it('fails when no such puzzle exists', function() {
      Messages.insert({
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: Date.now(),
  ...
  describe('newCallIn', function() {
    describe('of answer', function() {
      describe('in puzzle room', function() {
        it('infers puzzle', function() {
          ...
          return waitForDocument(CallIns, {answer: 'linear abeja'}, {
            target: '12345abcde',
            created: 7,
            created_by: 'torgen',
            touched: 7,
        ...
        return it('understands provided', function() {
          Puzzles.insert({
            _id: '12345abcde',
            name: 'Latino Alphabet',
            canon: 'latino_alphabet',
      ...
      return describe('in general room', function() {
        it('fails when puzzle is not specified', async function() {
          ...
          return chai.assert.isUndefined(CallIns.findOne());
        });
        ...
        return it('allows specifying puzzle', function() {
          Puzzles.insert({
            _id: '12345abcde',
            name: 'Latino Alphabet',
            canon: 'latino_alphabet',
    ...
    return describe('of expected callback', function() {
      describe('in puzzle room', function() {
        it('infers puzzle', function() {
          Puzzles.insert({
            _id: '12345abcde',
  ...
  describe('newPuzzle', () => drive.withValue(driveMethods, function() {
    ...
    it('creates in named meta', async function() {
      ...
      const puzz = await waitForDocument(Puzzles, {name: 'Latino Alphabet'}, {
        canon: 'latino_alphabet',
        feedsInto: [mid]
      });
      await waitForDocument(Puzzles, {_id: mid, puzzles: puzz._id}, {});
      return await waitForDocument(Rounds, {_id: rid, puzzles: [mid, puzz._id]}, {});
  });
    ...
    it('creates in this meta', async function() {
      ...
      return await waitForDocument(Puzzles, {_id: mid, puzzles: puzz._id}, {});
  });
    ...
    it('creates in named round', async function() {
      ...
      return chai.assert.deepInclude(Puzzles.findOne(mid), {puzzles: []});
  });
    ...
    it('fails when one exists by that name', async function() {
      ...
      return chai.assert.deepInclude(Rounds.findOne(rid), {puzzles: [mid]});
  });
    ...
    it('creates in this round', async function() {
      ...
      const puzz = await waitForDocument(Puzzles, {name: 'Latino Alphabet', puzzles: null}, {
        canon: 'latino_alphabet',
        feedsInto: []
      });
      await waitForDocument(Rounds, {_id: rid, puzzles: [mid, puzz._id]}, {});
    ...
    return it('fails when no such thing to create in', function() {
      Messages.insert({
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: Date.now(),
      ...
      return waitForDocument(Messages, {body: '@torgen: I can\'t find anything called "elliptic curve".'}, {
        nick: 'testbot',
        timestamp: 7,
        room_name: 'general/0',
        useful: true,
  ...
  describe('deletePuzzle', () => drive.withValue(driveMethods, function() {
    it('deletes puzzle', async function() {
      ...
      return chai.assert.isUndefined(Puzzles.findOne({_id: pid}));
    });

    return it('fails when puzzle does not exist', function() {
      Messages.insert({
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: Date.now(),
      ...
      return waitForDocument(Messages, { body: '@torgen: I can\'t find a puzzle called "foo".' }, {
        nick: 'testbot',
        room_name: 'general/0',
        timestamp: 7,
        useful: true,
  ...
  describe('newRound', function() {
    it('creates round', function() {
      ...
      return waitForDocument(Rounds, { name: 'Elliptic Curve' }, {
        canon: 'elliptic_curve',
        created: 7,
        created_by: 'torgen',
        touched: 7,
    ...
    return it('fails when one exists by that name', async function() {
      const rid = Rounds.insert({
        name: 'Elliptic Curve',
        canon: 'elliptic_curve',
        puzzles: []});
      ...
      return await waitForDocument(Messages, {body: {$regex: /@torgen: There's already.*a round named Elliptic Curve/}}, {
        nick: 'testbot',
        timestamp: 7,
        room_name: 'general/0',
        useful: true,
  ...
  describe('deleteRound', function() {
    it('deletes empty round', async function() {
      ...
      return chai.assert.isUndefined(Rounds.findOne({_id: rid}));
    });
    ...
    it('fails when round contains puzzles', async function() {
      ...
      return chai.assert.isObject(Rounds.findOne({_id: rid}));
    });

    return it('fails when round does not exist', function() {
      Messages.insert({
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: Date.now(),
      ...
      return waitForDocument(Messages, { body: '@torgen: I can\'t find a round called "elliptic curve".' }, {
        nick: 'testbot',
        timestamp: 7,
        room_name: 'general/0',
        useful: true,
  ...
  describe('setTag', function() {
    describe('in puzzle room', function() {
      it('infers puzzle', function() {
        ...
        return waitForDocument(Puzzles, {_id: '12345abcde', 'tags.color.value': 'blue' }, {
          tags: { color: {
            name: 'Color',
            touched_by: 'torgen',
            touched: 7,
      ...
      return it('allows specifying round', function() {
        Puzzles.insert({
          _id: '12345abcde',
          name: 'Latino Alphabet',
          canon: 'latino_alphabet',
        ...
        return waitForDocument(Rounds, {_id: 'fghij67890', 'tags.color.value': 'blue' }, {
          tags: { color: {
            name: 'Color',
            touched_by: 'torgen',
            touched: 7,
    ...
    describe('in round room', function() {
      ...
      return it('allows specifying round', function() {
        ...
        return waitForDocument(Rounds, {_id: '12345abcde', 'tags.color.value': 'blue' }, {
          tags: { color: {
            name: 'Color',
            touched_by: 'torgen',
            touched: 7,
    ...
    return describe('in general room', function() {
      it('fails when target is not specified', function() {
        ...
        return waitForDocument(Messages, {body: '@torgen: You need to tell me which puzzle this is for.'}, {
          nick: 'testbot',
          room_name: 'general/0',
          timestamp: 7,
          mention: ['torgen']
      ...
      it('fails when target does not exist', function() {
        ...
        return waitForDocument(Messages, {body: '@torgen: I can\'t find anything called "latino alphabet".'}, {
          nick: 'testbot',
          room_name: 'general/0',
          timestamp: 7,
          mention: ['torgen']
  ...
  describe('deleteTag', function() {
    describe('in puzzle room', function() {
      it('infers puzzle', function() {
        ...
        return waitForDocument(Puzzles, {_id: '12345abcde', 'tags.color': {$exists: false} }, {});
    });
      ...
      it('allows specifying round', function() {
        ...
        return waitForDocument(Rounds, {_id: 'fghij67890', 'tags.color': {$exists: false} }, {});
    });

      return it('complains if not set ', function() {
        Puzzles.insert({
          _id: '12345abcde',
          name: 'Latino Alphabet',
          canon: 'latino_alphabet',
        ...
        return waitForDocument(Messages, {body: '@torgen: Latino Alphabet didn\'t have Color set!'}, {
          nick: 'testbot',
          room_name: 'puzzles/12345abcde',
          timestamp: 7,
          mention: ['torgen']
    ...
    describe('in round room', function() {
      ...
      it('allows specifying round', function() {
        ...
        return waitForDocument(Rounds, {_id: '12345abcde', 'tags.color': {$exists: false} }, {});
    });
  ...
  describe('stuck', function() {
    describe('in puzzle room', function() {
      it('marks stuck without reason', function() {
        ...
        return waitForDocument(Puzzles, {_id: '12345abcde', 'tags.status.value': 'Stuck' }, {
          tags: { status: {
            name: 'Status',
            touched_by: 'torgen',
            touched: 7,
      ...
      it('marks stuck with reason', function() {
        ...
        return waitForDocument(Puzzles, {_id: '12345abcde', 'tags.status.value': 'Stuck: maparium is closed' }, {
          tags: { status: {
            name: 'Status',
            touched_by: 'torgen',
            touched: 7,
      ...
      return it('allows specifying puzzle', function() {
        ...
        return waitForDocument(Puzzles, {_id: 'fghij67890', 'tags.status.value': 'Stuck: maparium is closed' }, {
          tags: { status: {
            name: 'Status',
            touched_by: 'torgen',
            touched: 7,
    ...
    describe('in general room', function() {
      ...
      return it('fails on round', async function() {
        Rounds.insert({
          _id: '12345abcde',
          name: 'Latino Alphabet',
          canon: 'latino_alphabet',
        ...
        return chai.assert.deepInclude(Rounds.findOne('12345abcde'),
          {tags: {}});
    });
  });

    return describe('in round room', () => it('fails without puzzle', function() {
      Rounds.insert({
        _id: '12345abcde',
        name: 'Latino Alphabet',
        canon: 'latino_alphabet',
  ...
  describe('unstuck', function() {
    describe('in puzzle room', function() {
      it('marks unstuck', async function() {
        ...
        return chai.assert.deepInclude(Puzzles.findOne('12345abcde'),
          {tags: {}});
    });
      ...
      return it('allows specifying puzzle', function() {
        ...
        return waitForDocument(Puzzles, {_id: '12345abcde', tags: {}}, {
          touched: 7,
          touched_by: 'torgen'
        }
        );
    ...
    describe('in general room', function() {
      ...
      return it('fails when no such puzzle', function() {
        Messages.insert({
          nick: 'torgen',
          room_name: 'general/0',
          timestamp: Date.now(),
  ...
  describe('poll', function() {
    it('creates poll', async function() {
      ...
      const poll = await waitForDocument(Polls, {}, {
      ...
      return await waitForDocument(Messages, {poll: poll._id}, {
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: 7
      }
    ...
    it('requires two options', function() {
      ...
      return waitForDocument(Messages, {body: '@torgen: Must have between 2 and 5 options.' }, {
        nick: 'testbot',
        timestamp: 7,
        room_name: 'general/0',
        useful: true,
    ...
    return it('forbids more than five options', function() {
      Messages.insert({
        nick: 'torgen',
        room_name: 'general/0',
        timestamp: Date.now(),
  ...
  describe('global list', () => it('lists global settings', async function() {
    let k, v;
    for (k in all_settings) { v = all_settings[k]; v.ensure(); }
    Messages.insert({
      nick: 'torgen',
      room_name: 'general/0',
      timestamp: Date.now(),
    ...
    return await (async () => {
      ...
      for (k in all_settings) {
        v = all_settings[k];
        result.push(await waitForDocument(Messages, {nick: 'testbot', to: 'torgen', body: new RegExp(`^${v.name}:`)}, {
          room_name: 'general/0',
          timestamp: 7,
          useful: true
        }
  ...
  return describe('global set', function() {
    beforeEach(() => (() => {
      const result = [];
      for (let k in all_settings) {
        const v = all_settings[k];
        result.push(v.ensure());
      }
      return result;
    })());
    ...
    it('sets number', async function() {
      ...
      return chai.assert.equal(97, MaximumMemeLength.get());
    });
    ...
    it('sets boolean', async function() {
      ...
      return chai.assert.isFalse(EmbedPuzzles.get());
    });
    ...
    it('sets url', async function() {
      ...
      return chai.assert.equal('https://moliday.holasses/round', RoundUrlPrefix.get());
    });
    ...
    it('fails when setting does not exist', function() {
      ...
      return waitForDocument(Messages, {body: '@torgen: Sorry, I don\'t know the setting \'background color\'.'}, {
        nick: 'testbot',
        room_name: 'general/0',
        timestamp: 7,
        useful: true,
    ...
    return describe('when value has wrong format for setting', function() {
      it('fails for boolean', async function() {
        ...
        return chai.assert.isTrue(EmbedPuzzles.get());
      });
      ...
      it('fails for url', async function() {
        ...
        return chai.assert.equal('', RoundUrlPrefix.get());
      });

      return it('fails for number', async function() {
        Messages.insert({
          nick: 'torgen',
          room_name: 'general/0',
          timestamp: Date.now(),
        ...
        return chai.assert.equal(140, MaximumMemeLength.get());
      });
    });
  });
});

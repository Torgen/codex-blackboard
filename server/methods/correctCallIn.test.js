...
describe('correctCallIn', function() {
  ...
  describe('for answer', function() {
    ...
    it('fails without login', () => chai.assert.throws(() => Meteor.call('correctCallIn', callin)
    , Match.Error));
    
    it('fails with response', () => chai.assert.throws(() => callAs('correctCallIn', 'cjb', callin, 'close enough')
    , Match.Error));
    ...
    describe('when logged in', function() {
      ...
      it('updates puzzle', function() {
        ...
        return chai.assert.deepInclude(doc, {
          touched: 7,
          touched_by: 'cjb',
          solved: 7,
          solved_by: 'torgen',
  ...
  describe('for interaction request', function() {
    ...
    describe('when logged in', () => describe('without response', function() {
      beforeEach(() => callAs('correctCallIn', 'cjb', callin));
      ...
      it('does not oplog', function() {
        const o = Messages.find({room_name: 'oplog/0', dawn_of_time: {$ne: true}}).fetch();
        return chai.assert.lengthOf(o, 0);
      });
    ...
    describe('with response', function() {
      beforeEach(() => callAs('correctCallIn', 'cjb', callin, 'Make us some supersaturated Kool-Aid'));
    ...
    return it('does not notify meta chat for puzzle', function() {
      const meta = Puzzles.insert({
        name: 'Meta',
        canon: 'meta',
        created: 2,
      ...
      callAs('correctCallIn', 'cjb', callin);
      const m = Messages.find({room_name: `puzzles/${meta}`, dawn_of_time: {$ne: true}}).fetch();
      return chai.assert.lengthOf(m, 0);
    });
  });
  ...
  return describe('for expected callback', function() {
    beforeEach(function() {
      puzzle = Puzzles.insert({
        name: 'Foo',
        canon: 'foo',

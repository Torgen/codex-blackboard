...
const POPULATE_DB_WHEN_RESET = !Meteor.settings.production && !Meteor.isProduction;
...
Meteor.startup(function() {
  if (DO_BATCH_PROCESSING && POPULATE_DB_WHEN_RESET && (Rounds.find().count() === 0)) {
    ...
    return console.log('Done populating initial database.');
  }
});

...
describe('drag-and-drop', function() {
  ...
  return it('allows drag and drop within a meta', async function() {
    Router.EditPage();
    ...
    const drag = new PuzzleDrag(invent, meta(), round(), inventJQ[0], inventJQ[0].getBoundingClientRect().top + 10, dt);
    ...
    return chai.assert.isAbove(kidsJQ.offset().top, inventJQ.offset().top, 'after drag up 2');
  });
});
